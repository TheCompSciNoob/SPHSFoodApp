...
interface MealAPI {
    ...
    @GET("filter.php")
    fun filterByArea(@Query("a") area : String)

    @GET("filter.php")
    fun filterByIngredient(@Query("i") ingredient : String)
}
...
{  
   "categories":[  
      ...
      {  
         "idCategory":"8",
         "strCategory":"Seafood",
         "strCategoryThumb":"www.themealdb.com\/images\/category\/seafood.png",
      ...
      {  
         "idCategory":"9",
         "strCategory":"Sides",
         "strCategoryThumb":"www.themealdb.com\/images\/category\/sides.png",
